...
' ===== GetPath ===============================================================
' Returns parent directory of file w/o trailing separator

Public Function GetPath(FullPathToFile As String) As String
  Dim strNameExt As String
  strNameExt = GetFileName(FullPathToFile)
  GetPath = Left(FullPathToFile, Len(FullPathToFile) - Len(strNameExt) - 1)
End Function
